...
## Part 02. Засорение файловой системы
...
## Part 03. Очистка файловой системы

bash-скрипт. 
Скрипт запускается с 1 параметром.
Скрипт должен уметь очистить систему от созданных в Part 02 папок и файлов 3 способами:
...
Написать bash-скрипт для разбора логов **nginx** из Части 04 через **awk**.
...
С помощью утилиты GoAccess получить ту же информацию, что и в Части 05

Открыть веб интерфейс утилиты на локальной машине.

## Part 07. **Prometheus** и **Grafana**
...
## Part 08. Готовый дашборд

##### Установить готовый дашборд *Node Exporter Quickstart and Dashboard* с официального сайта **Grafana Labs**

##### Провести те же тесты, что и в Части 07
...
## Part 09. Дополнительно. Свой *node_exporter*
